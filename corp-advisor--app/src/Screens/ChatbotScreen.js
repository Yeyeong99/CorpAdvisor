...
function Chatbot() {
    ...
    return (_jsx("div", { className: "min-h-screen", children: hasMessages ? (
        ...
        // --- 메시지가 없을 때 ---
        _jsxs("div", { className: "flex flex-col justify-center items-center min-h-screen gap-6", children: [_jsx("header", { className: "py-6", children: _jsx("h1", { className: "text-3xl font-bold text-center", children: "\uAE08\uC735 \uC790\uBB38 \uCC57\uBD07" }) }), _jsx("div", { className: "bg-white p-4", children: FormContent })] })) }));
}
